...
const VALID_TRANSITIONS = {
    ...
    [STATES.UPDATING_GRADES]: [STATES.POLLING_PROGRESS, STATES.REFRESHING_MASTERY, STATES.ERROR],
    [STATES.POLLING_PROGRESS]: [STATES.POLLING_PROGRESS, STATES.REFRESHING_MASTERY, STATES.ERROR],
    [STATES.REFRESHING_MASTERY]: [STATES.VERIFYING, STATES.ERROR],
