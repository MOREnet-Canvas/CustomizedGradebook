 ...
 */
export async function runPLSync({ courseId, outcomeId, outcomeName, apiClient, onProgress = null, targetUserIds = null, setupOnly = false, cachedPLEntry = null, plScoreOverrides = null, onStudentsResolved = null }) {
    ...
    const sm = new PLOutlookStateMachine({
        ...
        targetUserIds, setupOnly, cachedPLEntry, plScoreOverrides, onStudentsResolved
    });
