...
// - false: Use existing REST/bulk pipeline
// Default: true (always use GraphQL path)
// Can be overridden to false via CG_CONFIG.USE_UNIFIED_GRAPHQL_ONLY if needed
export const USE_UNIFIED_GRAPHQL_ONLY = window.CG_CONFIG?.USE_UNIFIED_GRAPHQL_ONLY ?? true;
